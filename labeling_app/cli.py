...
def cmd_serve(args) -> int:
    ...
    print(f"[labeling] bundle   : {bundle} ({len(app.state.bundle.items)} items)", file=sys.stderr)
...
def main(argv: list[str] | None = None) -> int:
    ...
    s.add_argument("--backup-copy-to", default=None); s.set_defaults(func=cmd_serve)
    e = sub.add_parser("export"); e.add_argument("--data-dir", default=None); e.add_argument("--bundle", default=None); e.add_argument("--out", default=None); e.set_defaults(func=cmd_export)
    k = sub.add_parser("backup"); k.add_argument("--data-dir", default=None); k.add_argument("--bundle", default=None); k.add_argument("--copy-to", default=None); k.set_defaults(func=cmd_backup)
    t = sub.add_parser("status"); t.add_argument("--data-dir", default=None); t.add_argument("--bundle", default=None); t.set_defaults(func=cmd_status)
