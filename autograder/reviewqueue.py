...
REASONS: dict[str, ReasonSpec] = {s.code: s for s in (
    ...
    ReasonSpec("LOCAL_GRADER_UNAVAILABLE", "Local grading model unavailable", 0, False),
...
_TEXT_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("local grading model", "LOCAL_GRADER_UNAVAILABLE"),
    ("provider", "PROVIDER_FAILED"),
    ("verifier disagreement", "OCR_PROVIDER_DISAGREEMENT"),
    ("independent reading disagrees", "OCR_PROVIDER_DISAGREEMENT"),
