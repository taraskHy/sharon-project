# Two-layer grading report — qwen3-vl:8b-instruct (DEV, subset dev_verdict)
...
Run `dev__dev_verdict__all__qwen3-vl-8b-instruct__433146e4b1` | prompt `grade-v4-charitable` | backend `ollama` @ `http://localhost:11434/v1` | adapter `grade-bench-v2` | commit `9ac02197ff`
...
| metric | value |
| --- | --- |
| verdict exact | 69.23% (18/26) |
| balanced accuracy | 0.6137 |
| macro-F1 | 0.5818 |
| harmful verdict upgrades | 2 |
| harmful verdict downgrades | 6 |
...
| --- | --- |
| cases scored | 32 |
| exact final-score match | 75.0% (24/32) |
| mean absolute score error | 0.5625 |
| harmful overgrades (predicted > actual) | 2 |
| harmful undergrades (predicted < actual) | 6 |
...
| --- | --- |
| cases scored | 26 |
| exact final-score match | 69.23% (18/26) |
| mean absolute score error | 0.6923 |
| harmful overgrades (predicted > actual) | 2 |
| harmful undergrades (predicted < actual) | 6 |
