...
Run `dev__smoke__all__qwen3-vl-8b-instruct__0e78e83f11` | prompt `grade-v4-charitable-local` | backend `ollama` @ `http://localhost:11434/v1` | adapter `grade-bench-v3` | commit `ac3227a44c`
