# Two-layer grading report — qwen3.8:27b-q4_K_M (DEV, subset smoke)
...
Run `dev__smoke__all__qwen3.8-27b-q4_K_M__5d14887916` | prompt `grade-v4-charitable` | backend `ollama` @ `http://localhost:11434/v1` | adapter `grade-bench-v2` | commit `9ac02197ff`
...
| metric | value |
| --- | --- |
| verdict exact | 0.0% (0/2) |
| balanced accuracy | 0.0 |
| macro-F1 | 0.0 |
| harmful verdict upgrades | 0 |
| harmful verdict downgrades | 2 |
...
| --- | --- |
| cases scored | 8 |
| exact final-score match | 75.0% (6/8) |
| mean absolute score error | 0.5 |
| harmful overgrades (predicted > actual) | 0 |
| harmful undergrades (predicted < actual) | 2 |
...
| --- | --- |
| cases scored | 2 |
| exact final-score match | 0.0% (0/2) |
| mean absolute score error | 2.0 |
| harmful overgrades (predicted > actual) | 0 |
| harmful undergrades (predicted < actual) | 2 |
