# Two-layer grading report — qwen3-vl:30b-a3b-instruct (DEV, subset smoke)
...
Run `dev__smoke__all__qwen3-vl-30b-a3b-instruct__200ea3d551` | prompt `grade-v4-charitable-local` | backend `ollama` @ `http://localhost:11434/v1` | adapter `grade-bench-v3` | commit `ac3227a44c`
