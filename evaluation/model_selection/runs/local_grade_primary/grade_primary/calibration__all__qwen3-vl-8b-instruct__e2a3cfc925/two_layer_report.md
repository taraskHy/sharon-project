# Two-layer grading report — qwen3-vl:8b-instruct (CALIBRATION)
...
Run `calibration__all__qwen3-vl-8b-instruct__e2a3cfc925` | prompt `grade-v4-charitable-local` | backend `ollama` @ `http://localhost:11434/v1` | adapter `grade-bench-v3` | commit `77a4c2b0aa`
